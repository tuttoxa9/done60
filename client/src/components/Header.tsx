...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full relative overflow-hidden">
      ...
      {/* Контент шапки */}
      <div className="container-custom py-3 flex justify-between items-center relative z-10">
        <div>
          <Link href="/">
      ...
      {/* GradualBlur эффект внизу шапки */}
      <div className="absolute bottom-0 left-0 right-0 z-0 h-16">
        <GradualBlur
          position="bottom"
          height="4rem"
          strength={3}
