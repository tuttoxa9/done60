  ...
  const faqs = [
    {
      ...
      answer: "Средний доход курьера в Яндекс Доставке и других сервисах составляет 2000-5000 BYN в месяц. При полной занятости (8-10 часов в день) опытные курьеры зарабатывают 4000-5000 BYN. Начинающие курьеры обычно получают 2000-3000 BYN в первый месяц работы."
    },
    {
    ...
    {
      question: "В каких сервисах можно работать курьером?",
      answer: "Мы помогаем устроиться в Яндекс Доставку и другие популярные сервисы доставки еды в Минске. Яндекс Доставка — один из самых стабильных и высокооплачиваемых сервисов с постоянным потоком заказов."
    }
  ];
